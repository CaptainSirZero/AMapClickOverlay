...
- (MAOverlayRenderer *)mapView:(MAMapView *)mapView rendererForOverlay:(id <MAOverlay>)overlay{
    if ([overlay isKindOfClass:[SelectableOverlay class]])
    {
        ...
        {
            MACircleRenderer *circleView = [[MACircleRenderer alloc] initWithCircle:actualOverlay];
        ...
        {
            MAPolygonRenderer *polygonView = [[MAPolygonRenderer alloc] initWithPolygon:actualOverlay];
        ...
        {
            MAPolylineRenderer *polylineView = [[MAPolylineRenderer alloc] initWithPolyline:actualOverlay];
...
- (void)handleSingleTap:(UITapGestureRecognizer *)theSingleTap
{
    ...
    [self.mapView.overlays enumerateObjectsUsingBlock:^(id<MAOverlay> overlay, NSUInteger idx, BOOL * _Nonnull stop) {
        if ([overlay isKindOfClass:[SelectableOverlay class]])
        {
            SelectableOverlay *selectableOverlay = overlay;
            
            /* 获取overlay对应的view. */
            MAOverlayPathRenderer * View = (MAOverlayPathRenderer *)[self.mapView rendererForOverlay:selectableOverlay];
